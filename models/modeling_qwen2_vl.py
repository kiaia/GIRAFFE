...
class Qwen2RotaryEmbedding(nn.Module):
    def __init__(self, dim, max_position_embeddings=16384, base=10000, device=None, max_target_position=65536,mrope_section=[16:24:24]):
        super().__init__()
...
class Qwen2VLForConditionalGeneration(Qwen2VLPreTrainedModel):
    ...
    def get_rope_index(
        ...
        video_tokenn_id = self.config.video_token_id
